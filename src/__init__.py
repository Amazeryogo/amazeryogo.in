...
def index():
    # get gravatar image
    gravatar = "https://www.gravatar.com/avatar/%s?d=identicon&s=200" % hashlib.md5("suvid.datta@gmail.com".encode()).hexdigest()
...
def contact():
    ...
    return render_template('contactme.html', email=email, github=github, reddit=reddit, twitch=twitch, youtube=youtube, spotify=spotify)